...
<div class="relative">
	...
	{:else}
		<input
			...
			data-slot={dataSlot}
			class={cn(
				'flex h-10 w-full rounded-sm border border-input bg-input/50 px-3 py-2 text-base shadow-xs ring-offset-background transition-[color,box-shadow] outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50',
				paddingClass,
